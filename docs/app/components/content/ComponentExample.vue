  ...
  <div class="my-5">
    ...
    <template v-if="preview">
      <div class="relative group/component">
        <div class="border border-muted relative z-[1]" :class="[{ 'border-b-0 rounded-t-md': source, 'rounded-md': !source }]">
    ...
    <template v-if="source && ast">
      <MDCRenderer :body="ast.body" :data="ast.data" :class="[preview && '[&_pre]:!rounded-t-none [&_div.my-5]:!mt-0']" />
    </template>
  </div>
</template>
